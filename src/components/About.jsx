    ...
    <div className="bg-black mb-11">
      <div className="container mx-auto flex md:flex-row flex-col items-center justify-center">
        ...
        <div className="justify-center md:justify-end mt-4">
          ...
          <div className='pt-3  '>
          <a href="#subscribe" className='text-white border-primary border-2 p-1 rounded-lg text-sm  hover:shadow-md hover:shadow-primary transform transition-transform hover:scale-105 '>Subscribe</a>
        </div>
        </div>
      </div>
    </div>
